...
![People doing a Nando's point planning session](/images/devops/nandospoints.png)
...
**_"Well, it’s an 8 if Dave does it, but a 3 if Sarah does it."
"Is Fibonacci measuring complexity, effort, or risk?"
"Can we average the story points to 4.2?" (no, just, no.)_**

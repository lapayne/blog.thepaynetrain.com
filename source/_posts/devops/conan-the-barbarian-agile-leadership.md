...
To allow for this kind of speed, leaders must foster a "Psychological Safety" zone where teams feel empowered to take risks. If a deployment fails and the "serpents" sound the alarm, you don't punish the team. You conduct a Blameless Post-mortem. We aren't looking for a scapegoat to throw into the snake pit; we’re looking for a technical solution. We succeed as a team, or we get **deprecated** as a team. Just like Valeria a person can still be around once they've left the project in their automation and supporting work which can still save our heroes during times of peril.
...
You may be asking yourself how can I determine which type of Conan character each member of my DevOps team is? well finally you can answer that most important question using a 9 box model. This is the model you've likely seen a hundred times, this shows where people fit in your organization, not everyone can be a superstar and nor would you want that.
...
You can have the most expensive Kubernetes cluster in the world, the best in breed CI/CD and observability platforms but if your culture is a "Snake Cult" of top-down fear, you **will** fail. If you don't empower your T-shaped warriors, support your platform sidekicks, and listen to your data-driven wizards, your "kingdom" will fall to the next agile barbarian at the gates.

Most importantly for us The Riddle of Steel is this: Steel is only as strong as the hand that wields it. In DevOps, our "Steel" is the tooling (Terraform, Kubernetes, Jenkins , etc.). If your "Hand" (Culture) is weak, the tool will break in your hand when you face a production outage.
...
Always Remember Crom is watching... but he **doesn't** provide tech support.
